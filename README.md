# Leaflet / Elm Map Integration via Ports

This is a project for [DailyDrip](http://www.dailydrip.com) where we explore
interacting with a [Leaflet.js](http://www.leafletjs.com) map from an Elm
application via ports.

## Basic Create Elm App README Below:
